...
- **Challenge 1:** A feature I wanted was when you add a job to the board, it finds the company logo from an API and shows it seamlessly. A challenge I faced with this was finding a suitable API, and integrating it smoothly into the tool. These was surprisingly more difficult than expected, but once I found an API that worked well, I was happy with the result.
- **Challenge 2:** I wanted to gain user feedback, so I built a form using Typeform and integrated it into the application, and got several pieces of useful feedback I was able to fix!
